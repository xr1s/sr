...
use crate::po::message::{EmojiGroupType, Gender, ItemType, Sender};

use crate::{vo, GameData, Wiki};
...
#[derive(Clone, Debug)]
pub struct MessageGroupConfig<'a> {
    pub id: u16,
    pub contacts: MessageContactsConfig<'a>,
    pub section_list: Vec<MessageSectionConfig<'a>>,
}

#[derive(Clone, Debug)]
pub struct MessageItemConfig<'a> {
    pub id: u32,
    pub contacts: Option<MessageContactsConfig<'a>>,
    pub sender: Sender,
    pub r#type: ItemType,
    pub main_text: &'a str,
    pub content_id: u32,
...
pub struct MessageSectionConfig<'a> {
...
impl MessageSectionConfig<'_> {
    pub fn contacts(&self) -> &MessageContactsConfig<'_> {
    ...
    pub fn next_convergence_node(&self, next_ids: &[u32]) -> Option<MessageItemConfig> {
    ...
    fn wiki_message_single_item_content(
        ...
        match message.sender {
            ...
            Sender::Player | Sender::PlayerAuto => {
    ...
    fn wiki_message_single_selection_content(
        ...
        let is_sticker_selection = selections
            .iter()
            .all(|message| message.r#type == ItemType::Sticker);
